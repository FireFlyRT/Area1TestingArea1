...
namespace PaintCore
{
	public abstract class CwPaintableTexture : MonoBehaviour
	{
		...
		public static LinkedList<CwPaintableTexture> Instances { get { return instances; } } private static LinkedList<CwPaintableTexture> instances = new LinkedList<CwPaintableTexture>(); private LinkedListNode<CwPaintableTexture> instancesNode;
...
namespace PaintCore
{
	...
	public class CwPaintableTexture_Editor : CwEditor
	{
		...
		private bool CannotCopyTexture(CwPaintableTexture paintableTexture)
		{
			var texture = paintableTexture.Slot.FindTexture(paintableTexture.gameObject);
